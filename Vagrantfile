Vagrant.configure('2') do |config|
  ...
  config.vm.define "bosh-cli2" do |boshcli2|
    ...
    boshcli2.vm.provision "shell", inline: "echo export BOSH_CLIENT=admin >> /home/vagrant/.profile", privileged: false
    boshcli2.vm.provision "shell", inline: "echo export BOSH_CLIENT_SECRET=admin >> /home/vagrant/.profile", privileged: false
    ...
    boshcli2.vm.provision "shell", inline: "echo export BOSH_ENVIRONMENT=vbox >> /home/vagrant/.profile", privileged: false
    boshcli2.vm.provision "shell", inline: "git clone --single-branch -b mtls-demo https://github.com/ob1-sc/cf-deployment.git", privileged: false
    boshcli2.vm.provision "shell", name: "cf-deploy", privileged: false, path: "deploy-cf.sh"
    boshcli2.vm.provision "shell", name: "cf-deploy", privileged: true, path: "cf-cli-install.sh"
